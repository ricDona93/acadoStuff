...
int main(){
    ...
    const double t_sim_total = 2;

    VariablesGrid equidistantGrid( 2,0,2,5 );
    equidistantGrid.setZero();

    DVector OmegaRef( 2 );
    OmegaRef(0,0) = -0.5;
    OmegaRef(1,0) = 0.0;
    equidistantGrid.setVector( 1,OmegaRef );
    OmegaRef(0,0) = 0.6;
    OmegaRef(1,0) = 0.0;
    equidistantGrid.setVector( 2,OmegaRef );
    OmegaRef(0,0) = -0.2;
    OmegaRef(1,0) = 0.0;
    equidistantGrid.setVector( 3,OmegaRef );
    OmegaRef(0,0) = 0.0;
    OmegaRef(1,0) = 0.0;
    equidistantGrid.setVector( 4,OmegaRef );
    ...
    StaticReferenceTrajectory zeroReference (equidistantGrid);
